...
public class ShopItem : MonoBehaviour
{
	...
	private bool _isWagonSkin, _isAvailable;
	...
	public void SetIsWeaponItem(bool status) => _isWagonSkin = status;
	...
	public void ClickOnLocked()
	{
		...
		{
			if (_isWagonSkin)
				ShopEvents.InvokeWagonSkinSelect(_mySkinIndex, true);
			else
				ShopEvents.InvokeCharacterSkinSelect(_mySkinIndex, true);
			return;
		}
	}
	...
	public void ClickOnUnlocked()
	{
		...
		if (_isWagonSkin)
			ShopEvents.InvokeWagonSkinSelect(_mySkinIndex, false);
		else
			ShopEvents.InvokeCharacterSkinSelect(_mySkinIndex, false);
